...
This project submission solves one of [two versions](https://github.com/udacity/deep-reinforcement-learning/tree/master/p2_continuous-control) of the environment, the second Version: 20 Agents.
